...
export const playerTanksStatsModelDefinition = [
  ...
  { header: "survived %",        group: "ratios",       property: "survivedBattlesRatio" },
  { header: "damage",            group: "totals",       property: "damageDealt" },
  { header: "avg damage",        group: "avgs",         property: "avgDamageDealt" },
  ...
  { header: "xp",                group: "totals",       property: "xp" },
  { header: "avg xp",            group: "avgs",         property: "avgBattleXp" },
  { header: "frags",             group: "totals",       property: "frags" },
  { header: "avg frags",         group: "avgs",         property: "avgFrags" },
  { header: "spotted",           group: "totals",       property: "spotted" },
  { header: "avg spotted",       group: "avgs",         property: "avgSpotted" },
  { header: "shots",             group: "totals",       property: "shots" },
  { header: "avg shots",         group: "avgs",         property: "avgShots" },
  { header: "hits",              group: "totals",       property: "hits" },
  { header: "avg hits",          group: "avgs",         property: "avgHits" },
  { header: "hits %",            group: "ratios",       property: "hitsRatio" },
  { header: "piercings",         group: "totals",       property: "piercings" },
  { header: "avg piercings",     group: "avgs",         property: "avgPiercings" },
  { header: "piercings rcv",     group: "totals",       property: "piercingsReceived" },
  { header: "avg piercings rcv", group: "avgs",         property: "avgPiercingsReceived" },
  { header: "expl hits",         group: "totals",       property: "explosionHits" },
  { header: "avg expl hits",     group: "avgs",         property: "avgExplosionHits" },
  { header: "expl hits rcv",     group: "totals",       property: "explosionHitsReceived" },
  { header: "avg expl hits rcv", group: "avgs",         property: "avgExplosionHitsReceived" },
  { header: "hits rcv",          group: "totals",       property: "directHitsReceived" },
  { header: "avg hits rcv",      group: "avgs",         property: "avgDirectHitsReceived" },
  { header: "damage rcv",        group: "totals",       property: "damageReceived" },
  { header: "avg damage rcv",    group: "avgs",         property: "avgDamageReceived" },
  { header: "cap",               group: "totals",       property: "capturePoints" },
  { header: "avg cap",           group: "avgs",         property: "avgCapturePoints" },
  { header: "decap",             group: "totals",       property: "droppedCapturePoints" },
  { header: "avg decap",         group: "avgs",         property: "avgDroppedCapturePoints" },
