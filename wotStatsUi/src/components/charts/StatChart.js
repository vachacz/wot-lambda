    ...
    return (
     <Panel header={this.props.property}>
       <div className="App-chart-panel">
         <XYPlot fill="none" width={252} height={200} yDomain={ this.props.statChartRange }>
           <HorizontalGridLines />
           <LineMarkSeries color="green" curve="curveMonotoneX" data={this.props.statData} />
           <XAxis title="X" />
           <YAxis />
         </XYPlot>
         <XYPlot fill="none" width={252} height={200} yDomain={ this.props.effectiveStatChartRange }>
           <HorizontalGridLines />
           <LineMarkSeries color="green" curve="curveMonotoneX" data={this.props.statData} />
